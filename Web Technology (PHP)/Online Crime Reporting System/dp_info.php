<?php
     ...
     $result = mysql_query("SELECT * FROM create_stations WHERE address='Dhanmondi'ORDER BY username DESC");
?>
<!DOCTYPE html>
<head>
    <title>Info</title>
...
<body>
	...
	<div id="top-header">
		...
		<ul id="main-menu">
			<li><a href="dhanmondi_police.php">Report</a></li>
			<li><a href="dp_info.php">Info</a></li>
