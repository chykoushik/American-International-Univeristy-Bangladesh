...
<body>
	...
	<form action="add1.php" method="post" enctype="multipart/form-data" name="addroom">
        Select Image: <br />
...
$result = mysql_query("SELECT * FROM missing ORDER BY id DESC");
while($row = mysql_fetch_array($result))
{
echo '<div id="imagelist">';
echo '<p><img src="'.$row['location'].'"></p>';
echo '<p id="caption">'.$row['caption'].' </p>';
echo "<p><a href=\"remove_missing.php?id=$row[id]\" onClick=\"return confirm('Are you sure you want to Remove?')\">x</a></p>";
echo '</div>';
}