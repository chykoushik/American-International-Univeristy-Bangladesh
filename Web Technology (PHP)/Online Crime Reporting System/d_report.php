...
<body>
	...
	<form method="post" action="d_report.php">
...
<?php
	 ...
	 if(isset($_POST['Submit'])) {	
		...
		$query = mysql_query("INSERT INTO dhanmondi(report_type,complainant,caddress,cemail,cphone,suspect,nsuspect,saddress,arms,sphone,details) VALUES('$report_type','$complainant','$caddress','$cemail','$cphone','$suspect','$nsuspect','$saddress','$arms','$sphone','$details')");
