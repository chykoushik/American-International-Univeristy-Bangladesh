...
<body>
	...
	<div id="top-header">
		<div id="police-logo">
			...
			<h2>Banani Police Station</h2>
		</div>
		<ul id="main-menu">
		   <li><a href="banani.php">Home</a></li>
			<li><a href="b_info.php">Info</a></li>
			<li><a href="b_report.php">Report</a></li>
			<li><a href="b_wanted_criminals.php">Wanted Criminal</a></li>
			<li><a href="b_missing_public.php">Missing Person</a></li>
	...
	<form method="post" action="b_report.php">
...
<?php
	 ...
	 if(isset($_POST['Submit'])) {	
		...
		$query = mysql_query("INSERT INTO banani(report_type,complainant,caddress,cemail,cphone,suspect,nsuspect,saddress,arms,sphone,details) VALUES('$report_type','$complainant','$caddress','$cemail','$cphone','$suspect','$nsuspect','$saddress','$arms','$sphone','$details')");
