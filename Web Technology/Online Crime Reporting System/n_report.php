...
<body>
	...
	<div id="top-header">
		...
		<form method="post" action="n_report.php">
...
<?php
	 ...
	 if(isset($_POST['Submit'])) {	
		...
		$query = mysql_query("INSERT INTO newmarket(report_type,complainant,caddress,cemail,cphone,suspect,nsuspect,saddress,arms,sphone,details) VALUES('$report_type','$complainant','$caddress','$cemail','$cphone','$suspect','$nsuspect','$saddress','$arms','$sphone','$details')");
